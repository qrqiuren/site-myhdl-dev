...
can be answered in one of these two outlets.
   ...
   * [MyHDL gitter](https://gitter.im/jandecaluwe/myhdl)
...
Before a question
is posted to the mailing-list or IRC care should be taken to construct
...
and its impact.  This project shall support the MEP114 `@mydhdl.block`
inclusion.
...
An alternative, is to parse the top-level block ports and
